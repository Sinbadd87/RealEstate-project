...
const ProjectPageCard = () => {
  ...
  const project = isSuccess ? data[0] : {};
          ...
          <div className="aboutProject">
            <div className="aboutText">
              ...
              <p>
                ...
                Voluptatem sequi, a vero necessitatibus nulla id porro dolores
                exercitationem magnam reiciendis iste expedita officia fugit
                praesentium corrupti incidunt temporibus totam commodi. Lorem
                ipsum dolor sit amet consectetur, adipisicing elit. Rem libero
                voluptates aspernatur, maiores aliquam quaerat ratione?
                Provident inventore, eligendi similique, explicabo placeat, quas
                pariatur natus commodi vero quasi saepe reprehenderit?
              </p>
              <button className="btnProjectPage">
                <Link
                  to={`/projects/${id}/apartments`}
